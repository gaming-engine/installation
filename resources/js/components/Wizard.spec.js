    ...
    describe('computed', () => {
        describe('step width', () => {
            it.each`
                ...
                ${[[1], [2], [3], [4], [5]]} | ${2}
            `(
                'will set up the $columnTotal columns when $stepList.length are provided',
                ({ stepList, columnTotal }) => {
                    const { vm } = shallowMount(Wizard, {
                        props: {
                            steps: stepList,
        ...
        describe('has next step', () => {
            ...
            it('if there are multiple steps, and you are at the beginning, then you will see more', () => {
                const { vm } = shallowMount(Wizard, {
                    props: {
                        steps,
                    },
            ...
            it('if there are multiple steps, and you are at the end, then you will not see any', () => {
                const { vm } = shallowMount(Wizard, {
                    props: {
                        steps,
                    },
            ...
            it('if there are multiple steps, and you are in the middle, then you will see more', () => {
                const { vm } = shallowMount(Wizard, {
                    props: {
                        steps,
                    },
        ...
        describe('next step', () => {
            ...
            it('if another element is incomplete, it will return the related index', () => {
                const { vm } = shallowMount(Wizard, {
                    props: {
                        steps,
                    },
